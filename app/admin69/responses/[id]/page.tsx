...
export default async function AdminResponsesPage({ params }: { params: { id: string } }) {
    ...
    return (
        <div className="max-w-[1800px] mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700 p-6">
            <div className="mb-8">
                <Link href="/admin69">
